...
Java based student attendance system using JDBC and PostgreSQL, supporting full CRUD operations.

#Project-Statement
Managing student attendance manually is error-prone and difficult to maintain.
...
# Features
  ...
  * Drop the entire table if needed
